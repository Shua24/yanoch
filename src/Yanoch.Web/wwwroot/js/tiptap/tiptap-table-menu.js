...
function closeTableBubbleMenu(inst) {
  if (inst.tableMenuEl) {
...
function updateTableBubbleMenu(editor, inst) {
  ...
  // Find the selected cell DOM element
  let cellDOM = null
  try {
...
export { closeTableBubbleMenu, updateTableBubbleMenu }