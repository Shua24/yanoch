...
var hF = mF((e) => {
	...
	addNodeView() {
		return ({ node: e }) => {
			...
			let n = "all";
			function r() {
				t.querySelectorAll(".todo-filter-btn").forEach((e) => e.classList.remove("active"));
				let e = t.querySelector(`.todo-filter-btn[data-filter="${n}"]`);
				e && e.classList.add("active"), t.querySelectorAll("tbody tr").forEach((e) => {
